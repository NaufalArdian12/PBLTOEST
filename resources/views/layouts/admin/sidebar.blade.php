...
<aside id="sidebar"
    class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-xl transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('dashboard') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                    ...
                    <li>
                        <a href="{{ route('student.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('student.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('registration.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('registration.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('toeic.index') ?? '#' }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('toeic.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('major.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('major.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('studyprogram.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('studyprogram.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('campus.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('campus.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('admin.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <li>
                        <a href="{{ route('educationalstaff.index') }}"
                            ...
                            <div
                                class="flex-shrink-0 {{ request()->routeIs('educationalstaff.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
