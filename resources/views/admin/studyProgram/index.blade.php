...
@section('title', 'Study Program Management')
@section('header', 'Manage Study Programs')
        ...
        <div class="flex-1 overflow-auto">
            <div class="p-5">
                ...
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Manage Study Program</h1>
                        <p class="mt-1 text-sm text-gray-600">Create, view, and manage study programs across different campuses</p>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-small text-gray-500 uppercase tracking-wider">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <button type="button" class="group inline-flex items-center hover:text-gray-700" id="sortByName">
                                            Study Program Name
                                            <svg class="ml-1 h-3 w-3 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <button type="button" class="group inline-flex items-center hover:text-gray-700" id="sortByCampus">
                                            Campus
                                            <svg class="ml-1 h-3 w-3 text-gray-400 group-hover:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"></path>
                                            </svg>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="studyProgramTableBody">
                                @forelse($studyprograms as $index => $studyprogram)
                                    <tr class="hover:bg-gray-50 transition-colors duration-150" data-campus="{{ $studyprogram->campus->campus_name ?? '' }}">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="checkbox" class="row-checkbox rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                                value="{{ $studyprogram->id }}" data-name="{{ $studyprogram->study_program_name }}">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($studyprogram->description)
                                                <div class="text-sm text-gray-500 truncate max-w-xs">
                                                    {{ Str::limit($studyprogram->description, 50) }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($studyprogram->major)
                                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                                    {{ $studyprogram->major->major_name }}
                                                </span>
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-2 text-sm text-gray-900">
                                                    {{ $studyprogram->campus->campus_name ?? '-' }}
                                                </div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div class="flex items-center space-x-3">
                                                <!-- View Button -->
                                                <a href="{{ route('studyprogram.show', $studyprogram->id) }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-name="{{ $studyprogram->study_program_name }}">
                                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                                                    </svg>
                                                </button>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="text-sm font-medium text-gray-900 mb-1">No study programs found</h3>
                                                <p class="text-sm text-gray-500 mb-4">Get started by creating your first study program.</p>
                                                <a href="{{ route('admin.studyprograms.create') }}"
