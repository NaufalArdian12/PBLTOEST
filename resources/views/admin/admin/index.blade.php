        ...
        <div class="flex-1 overflow-auto">
            <div class="p-5">
                ...
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Manage Admin</h1>
                        <p class="mt-1 text-sm text-gray-600">Create, view, and manage Adminss across different
                            Admins</p>
                    </div>
                </div>
                    ...
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <select id="adminFilter"
                            ...
                            @foreach($admins as $admin)
                                <option value="{{ $admin->user->name}}">{{ $admin->user->name }}</option>
                            @endforeach
                        </select>

                        <!-- Search Input -->
                        <div class="relative">
                            <input type="text" placeholder="Search admins..." id="searchadmin"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($admin->description)
                                                <div class="text-sm text-gray-500 truncate max-w-xs">
                                                    {{ Str::limit($admin->description, 50) }}
                                                </div>
                                            @endif
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-sm text-gray-500 mb-4">Get started by creating your first admin.</p>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                function performSearch() {
                    ...
                    const selectedadmin = adminFilter.value.toLowerCase();
                    ...
                    rows.forEach(row => {
                        ...
                        const matchesadmin = selectedadmin === '' || admin.includes(selectedadmin);
                ...
                adminFilter.addEventListener('change', performSearch);
                ...
                bulkActionBtn.addEventListener('click', function () {
                    ...
                    if (confirm(`Are you sure you want to delete ${checkedBoxes.length} admin(s)?\n\n${names.join('\n')}\n\nThis action cannot be undone.`)) {
                ...
                document.getElementById('sortByadmin')?.addEventListener('click', () => sortTable('admin', 4));
