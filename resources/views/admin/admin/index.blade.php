        ...
        <div class="flex-1 overflow-auto">
            <div class="p-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div class="flex items-center space-x-2">
                                                <a href="{{ route('mahasiswa.show', $admin->id) }}"
                                                    class="text-blue-600 hover:text-blue-900">View</a>
                                                <a href="{{ route('mahasiswa.edit', $admin->id) }}"
                                                    class="text-yellow-600 hover:text-yellow-900">Edit</a>
                                                <form action="{{ route('mahasiswa.destroy', $admin->id) }}" method="POST"
                                                    class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                    ...
                    <!-- Pagination -->
                    @if($admins instanceof \Illuminate\Pagination\Paginator || $admins instanceof \Illuminate\Pagination\LengthAwarePaginator)
