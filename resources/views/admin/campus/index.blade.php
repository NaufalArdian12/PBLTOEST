        ...
        <div class="flex-1 overflow-auto">
            <div class="p-5">
                ...
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Manage Campus</h1>
                        <p class="mt-1 text-sm text-gray-600">Create, view, and manage Campuses across different
                            Campuses</p>
                    </div>
                </div>
                ...
                <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
                        ...
                        <!-- Search Input -->
                        <div class="relative">
                            <input type="text" placeholder="Search campuses..." id="searchcampus"
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="campusTableBody">
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-150"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="checkbox"
                                                ...
                                                value="{{ $campus->id }}" data-name="{{ $campus->campus_name }}">
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            @if($campus->description)
                                                <div class="text-sm text-gray-500 truncate max-w-xs">
                                                    {{ Str::limit($campus->description, 50) }}
                                                </div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <button type="button"
                                                    ...
                                                    title="Delete" data-id="{{ $campus->id }}"
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="text-sm font-medium text-gray-900 mb-1">No campuses found</h3>
                                                <p class="text-sm text-gray-500 mb-4">Get started by creating your first campus.
                                                </p>
                                                <a href="{{ route('campus.create') }}"
                    ...
                    <!-- Create Campus Modal -->
                    <div id="createCampusModal" aria-modal="true" aria-labelledby="createCampusModalLabel"
                        class="fixed inset-0 items-center justify-center z-50 hidden bg-gray-900/50">
                        <div class="bg-white rounded-lg shadow-lg w-96">
                            <form id="createCampusForm" class="p-6">
                                @csrf
                                <div class="flex justify-between items-center">
                                    <h5 class="text-xl font-semibold text-gray-900">Add New Campus </h5>
                                    <a href="{{route('campus.create')}}" type="button"
                                        class="text-gray-500 hover:text-gray-900" aria-label="Close">
                                ...
                                <div class="mt-4">
                                    <label for="campus_name" class="block text-sm font-medium text-gray-700">Campus Name
                                        <span class="text-red-500">*</span></label>
                                    <input type="text"
                                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                        id="campus_name" name="campus_name" placeholder="Input Campus Name" required>
                                    <div class="text-red-500 text-xs mt-1" id="campus_name_error">
                                    </div>
                                </div>
                                ...
                                <div class="mt-6 flex justify-between items-center">
                                    ...
                                    <button type="submit"
                                        ...
                                        id="submitBtn">
                                        <span class="hidden animate-spin -ml-1 mr-2 h-4 w-4 text-white" role="status"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600/50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            ...
            <div class="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                ...
                <form id="deleteForm" method="POST" class="inline" action="/campus/:id">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                bulkActionBtn.addEventListener('click', function () {
                    ...
                    if (confirm(`Are you sure you want to delete ${checkedBoxes.length} campus(s)?\n\n${names.join('\n')}\n\nThis action cannot be undone.`)) {
